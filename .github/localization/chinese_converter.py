...
INPUT_FILE_PATH = Path('config/openloader/resources/quests/assets/gte/lang/zh_cn.json')
OUTPUT_FILE_PATH = Path('config/openloader/resources/quests/assets/gte/lang/zh_tw.json')
