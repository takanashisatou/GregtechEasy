...
# Clean up debug file if present
if os.path.exists("debug_run.bat"):
    os.remove("debug_run.bat")

print("run_game.bat cleanly regenerated without unescaped parentheses!")
