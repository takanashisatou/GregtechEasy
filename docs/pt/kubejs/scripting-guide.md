...
├── server_scripts/      # 【Scripts de servidor】Executados ao entrar em um mundo/servidor, usados para registrar/modificar receitas e tags
├── client_scripts/      # 【Scripts de cliente】Executados no cliente, usados para modificar Tooltips, exibição de interface JEI/EMI
...
GTCEuStartupEvents.registry('gtceu:material', event => {
    ...
    // 2. Registrar Metal Fluido Escuro (Dark Fluid)
...
## ⚙️ Servidor: Receitas Personalizadas e Escrita de Receitas de Máquinas (`server_scripts/`)
...
ServerEvents.recipes(event => {
    ...
    // Prensagem de processador lógico
...
### 2. Receitas de Máquinas Personalizadas do GTECore
...
Teste modificações de scripts em tempo real sem reiniciar o cliente:

- **Recarregar receitas e scripts de servidor**:
  ```mcfunction
  /kubejs reload server_scripts
  ```
- **Recarregar materiais e scripts de cliente**:
  ```mcfunction
