...
```mermaid
graph LR
    A[Materias primas / Minerales en bruto / Productos químicos] --> B[Fábrica de Componentes / Fábrica de Circuitos]
    A --> C[Centro Integral de Procesamiento de Minerales 7 modos]
    A --> D[Planta Petroquímica Integral / Torre de Desulfuración]
    B & C & D --> E[Anillo del Milagro 1B paralelo sin investigación]
