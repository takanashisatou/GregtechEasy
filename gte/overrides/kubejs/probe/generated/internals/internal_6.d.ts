...
declare namespace Internal {
    ...
    interface IContext <TEntity> {
        abstract geoInstance(): Internal.AnimatableEntity<any>;
        abstract animationEvent(): Internal.AnimationEvent<any>;
        abstract mc(): Internal.Minecraft;
        abstract createChild<TChild>(arg0: TChild): Internal.IContext<TChild>;
        abstract entity(): TEntity;
        abstract random(): Internal.Random;
        abstract data(): Internal.EntityModelData;
        abstract tempStorage(): Internal.ITempVariableStorage;
        abstract scopedStorage(): Internal.IScopedVariableStorage;
        abstract level(): Internal.ClientLevel;
        abstract foreignStorage(): Internal.IForeignVariableStorage;
        abstract animationControllerContext(): Internal.AnimationControllerContext;
    }
    type IContext_<TEntity> = IContext<TEntity>;
    interface IValue {
        abstract get(): number;
        (): number;
    }
    ...
    interface NotContainer extends net.minecraft.world.Container {
    ...
    type NotContainer_ = NotContainer;
    /**
     * @deprecated
    */
    ...
    type AppMekItems$1_ = AppMekItems$1;
    ...
    abstract class GeometryStep$ProgramImpl {
        constructor()
        getClass(): typeof any;
        hashCode(): number;
        toString(): string;
        abstract setData(arg0: Internal.UniformDataManager_, arg1: Internal.GeometryStep_): void;
        wait(): void;
        notifyAll(): void;
        wait(arg0: number): void;
        emitCode(vertBuilder: Internal.VertexGeomBuilder_, fragBuilder: Internal.FPFragmentBuilder_, varyingHandler: Internal.VaryingHandler_, uniformHandler: Internal.UniformHandler_, shaderCaps: Internal.ShaderCaps_, geomProc: Internal.GeometryStep_, outputColor: string, outputCoverage: string, texSamplers: number[]): void;
        equals(arg0: any): boolean;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        get class(): typeof any
    }
    type GeometryStep$ProgramImpl_ = GeometryStep$ProgramImpl;
    class CraftGuide$SpecialOP extends Internal.Enum<Internal.CraftGuide$SpecialOP> {
        static values(): Internal.CraftGuide$SpecialOP[];
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.CraftGuide$SpecialOP>>;
        getClass(): typeof any;
        toString(): string;
        notifyAll(): void;
        static valueOf(arg0: string): Internal.CraftGuide$SpecialOP;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        getDeclaringClass(): typeof Internal.CraftGuide$SpecialOP;
        name(): string;
        hashCode(): number;
        compareTo(arg0: Internal.CraftGuide$SpecialOP_): number;
        "compareTo(studio.fantasyit.maid_storage_manager.items.CraftGuide$SpecialOP)"(arg0: Internal.CraftGuide$SpecialOP_): number;
        ordinal(): number;
        wait(): void;
        wait(arg0: number): void;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        get class(): typeof any
        get declaringClass(): typeof Internal.CraftGuide$SpecialOP
        static readonly NONE: (Internal.CraftGuide$SpecialOP) & (Internal.CraftGuide$SpecialOP);
        static readonly REPLACE: (Internal.CraftGuide$SpecialOP) & (Internal.CraftGuide$SpecialOP);
        static readonly COPY: (Internal.CraftGuide$SpecialOP) & (Internal.CraftGuide$SpecialOP);
    }
    type CraftGuide$SpecialOP_ = "replace" | "copy" | CraftGuide$SpecialOP | "none";
    ...
    class ProxySelector$StaticProxySelector extends Internal.ProxySelector {
        getClass(): typeof any;
        toString(): string;
        notifyAll(): void;
        connectFailed(arg0: Internal.URI_, arg1: Internal.SocketAddress_, arg2: Internal.IOException_): void;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        hashCode(): number;
        select(arg0: Internal.URI_): Internal.List<Internal.Proxy>;
        wait(): void;
    ...
    type ProxySelector$StaticProxySelector_ = ProxySelector$StaticProxySelector;
    ...
    class ItemMekanismSword extends Internal.SwordItem implements Internal.IAttributeRefresher, Internal.IHasRepairType {
        constructor(material: any_, properties: Internal.Item$Properties_)
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
        isEnderMask(arg0: Internal.ItemStack_, arg1: Internal.Player_, arg2: Internal.EnderMan_): boolean;
    ...
    type ItemMekanismSword_ = ItemMekanismSword;
    ...
    */
    ...
    class RecordingContextOptions extends Internal.BaseContextOptions {
        constructor()
        getClass(): typeof any;
        hashCode(): number;
        toString(): string;
    ...
    type RecordingContextOptions_ = RecordingContextOptions;
    ...
    class EnumListEntry <T extends Internal.Enum<any>> extends Internal.SelectionListEntry<T> {
        constructor(fieldName: net.minecraft.network.chat.Component_, clazz: T, value: T, resetButtonKey: net.minecraft.network.chat.Component_, defaultValue: Internal.Supplier_<T>, saveConsumer: Internal.Consumer_<T>, enumNameProvider: Internal.Function_<Internal.Enum<any>, net.minecraft.network.chat.Component>, tooltipSupplier: Internal.Supplier_<Internal.Optional<net.minecraft.network.chat.Component[]>>, requiresRestart: boolean)
        constructor(fieldName: net.minecraft.network.chat.Component_, clazz: T, value: T, resetButtonKey: net.minecraft.network.chat.Component_, defaultValue: Internal.Supplier_<T>, saveConsumer: Internal.Consumer_<T>, enumNameProvider: Internal.Function_<Internal.Enum<any>, net.minecraft.network.chat.Component>)
        constructor(fieldName: net.minecraft.network.chat.Component_, clazz: T, value: T, resetButtonKey: net.minecraft.network.chat.Component_, defaultValue: Internal.Supplier_<T>, saveConsumer: Internal.Consumer_<T>)
        constructor(fieldName: net.minecraft.network.chat.Component_, clazz: T, value: T, resetButtonKey: net.minecraft.network.chat.Component_, defaultValue: Internal.Supplier_<T>, saveConsumer: Internal.Consumer_<T>, enumNameProvider: Internal.Function_<Internal.Enum<any>, net.minecraft.network.chat.Component>, tooltipSupplier: Internal.Supplier_<Internal.Optional<net.minecraft.network.chat.Component[]>>)
        ...
        */
        ...
        static readonly DEFAULT_NAME_PROVIDER: Internal.Function<Internal.Enum<any>, net.minecraft.network.chat.Component>;
    }
    type EnumListEntry_<T extends Internal.Enum<any>> = EnumListEntry<T>;
    abstract class RenderType extends Internal.RenderStateShard implements Internal.RenderTypeAccessor {
        ...
        static catnip$create_$md$6e19f6$0(arg0: string, arg1: Internal.VertexFormat_, arg2: Internal.VertexFormat$Mode_, arg3: number, arg4: boolean, arg5: boolean, arg6: Internal.RenderType$CompositeState_): Internal.RenderType$CompositeRenderType;
    ...
    class RadioactiveCellItem extends Internal.AEBaseItem implements Internal.ICellWorkbenchItem {
        ...
        */
        ...
        set craftingRemainder(arg0: Internal.Item_)
        get registryName(): ResourceLocation
        static readonly HANDLER: (Internal.RadioactiveCellItem$Handler) & (Internal.RadioactiveCellItem$Handler);
    }
    type RadioactiveCellItem_ = RadioactiveCellItem;
    class SimulateExploreAllPathsProgramBehaviour$ExecutionPath extends Internal.Record {
        constructor()
        constructor(history: Internal.List_<Internal.SimulateExploreAllPathsProgramBehaviour$ExecutionPathElement>)
        getClass(): typeof any;
        toString(): string;
        notifyAll(): void;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        fork(): this;
        stream(): Internal.Stream<Internal.SimulateExploreAllPathsProgramBehaviour$ExecutionPathElement>;
        hashCode(): number;
        streamBranches(): Internal.Stream<Internal.SimulateExploreAllPathsProgramBehaviour$Branch>;
        wait(): void;
        wait(arg0: number): void;
        equals(arg0: any): boolean;
        history(): Internal.List<Internal.SimulateExploreAllPathsProgramBehaviour$ExecutionPathElement>;
        get class(): typeof any
    }
    type SimulateExploreAllPathsProgramBehaviour$ExecutionPath_ = SimulateExploreAllPathsProgramBehaviour$ExecutionPath;
    interface CropBlockAccessor {
        abstract tlmAgeProperty(): Internal.IntegerProperty;
    ...
    class ExtraItemBlockBin extends Internal.ExtraItemBlockTooltip<Internal.ExtraBlockBin> implements Internal.IItemSustainedInventory {
        constructor(arg0: Internal.ExtraBlockBin_)
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
        isEnderMask(arg0: Internal.ItemStack_, arg1: Internal.Player_, arg2: Internal.EnderMan_): boolean;
        ...
        isEnabled(arg0: Internal.FeatureFlagSet_): boolean;
        canContentsDrop(arg0: Internal.ItemStack_): boolean;
        getDestroySpeed(arg0: Internal.ItemStack_, arg1: Internal.BlockState_): number;
        getBurnTime(arg0: Internal.ItemStack_, arg1: Internal.RecipeType_<any>): number;
        onDestroyed(arg0: Internal.ItemEntity_): void;
        isFireResistant(): boolean;
        ...
        */
        ...
        isValidRepairItem(arg0: Internal.ItemStack_, arg1: Internal.ItemStack_): boolean;
        getXpRepairRatio(arg0: Internal.ItemStack_): number;
        getBlock(): Internal.ExtraBlockBin;
        isBookEnchantable(arg0: Internal.ItemStack_, arg1: Internal.ItemStack_): boolean;
        getCreativeTab(): string;
        initCapabilities(arg0: Internal.ItemStack_, arg1: Internal.CompoundTag_): Internal.ICapabilityProvider;
        asItem(): Internal.Item;
        ...
        */
        ...
        getRenderPropertiesInternal(): any;
        onEntityItemUpdate(arg0: Internal.ItemStack_, arg1: Internal.ItemEntity_): boolean;
        getAdvanceTier(): Internal.IAdvancedTier;
        interactLivingEntity(arg0: Internal.ItemStack_, arg1: Internal.Player_, arg2: Internal.LivingEntity_, arg3: Internal.InteractionHand_): Internal.InteractionResult;
        getCraftingRemainingItem(arg0: Internal.ItemStack_): Internal.ItemStack;
        useOn(arg0: Internal.UseOnContext_): Internal.InteractionResult;
        /**
        ...
        */
        ...
        readShareTag(arg0: Internal.ItemStack_, arg1: Internal.CompoundTag_): void;
        getEquipmentSlot(arg0: Internal.ItemStack_): Internal.EquipmentSlot;
        getTextColor(arg0: Internal.ItemStack_): Internal.TextColor;
        getName(arg0: Internal.ItemStack_): net.minecraft.network.chat.Component;
        /**
         * @deprecated
        */
        ...
        */
        get foodProperties(): Internal.FoodProperties
        get descriptionId(): string
        get block(): Internal.ExtraBlockBin
        get creativeTab(): string
        get typeData(): Internal.CompoundTag
        get defaultInstance(): Internal.ItemStack
        set burnTime(i: number)
        ...
        */
        ...
        get class(): typeof any
        get renderPropertiesInternal(): any
        get advanceTier(): Internal.IAdvancedTier
        set itemBuilder(b: Internal.ItemBuilder_)
        set craftingRemainingItemFTBL(arg0: Internal.Item_)
        set attackDamage(attackDamage: number)
        get edible(): boolean
    ...
    type ExtraItemBlockBin_ = ExtraItemBlockBin;
    ...
    interface OperationTrackers$Tracker {
        abstract isSelectorAlive(): boolean;
        abstract getName(): string;
        abstract getOutstandingWebSocketOperations(): number;
        abstract getOutstandingOperations(): number;
        abstract isImplementationReferenced(): boolean;
        abstract getOutstandingTcpConnections(): number;
        abstract getOutstandingSubscribers(): number;
        abstract isFacadeReferenced(): boolean;
        abstract getOutstandingHttp2Streams(): number;
        abstract getOutstandingHttpOperations(): number;
        abstract getOutstandingHttpRequests(): number;
        get selectorAlive(): boolean
        get name(): string
        get outstandingWebSocketOperations(): number
        get outstandingOperations(): number
        get implementationReferenced(): boolean
        get outstandingTcpConnections(): number
        get outstandingSubscribers(): number
        get facadeReferenced(): boolean
        get outstandingHttp2Streams(): number
        get outstandingHttpOperations(): number
        get outstandingHttpRequests(): number
    }
    type OperationTrackers$Tracker_ = OperationTrackers$Tracker;
    ...
    class GeckoChairEntity extends Internal.AnimatableEntity<Internal.EntityChair> {
        constructor(arg0: Internal.EntityChair_)
        getClass(): typeof any;
        getEntity(): Internal.EntityChair;
        getModelLocation(): ResourceLocation;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        getAnimationData(): Internal.AnimationData;
        getCurrentTick(arg0: Internal.AnimationEvent_<any>): number;
        getSeekTime(): number;
        getAnimationFileLocation(): ResourceLocation;
        getTextureLocation(): ResourceLocation;
        setMolangQueries(arg0: number): void;
        codeAnimations(arg0: Internal.AnimationEvent_<any>): void;
        getChairInfo(): Internal.ChairModelInfo;
        registerControllers(): void;
        setCustomAnimations(arg0: Internal.AnimationContext_<any>, arg1: Internal.AnimationEvent_<any>): boolean;
        getAnimation(arg0: string): com.github.tartaricacid.touhoulittlemaid.geckolib3.core.builder.Animation;
        getAnimationProcessor(): com.github.tartaricacid.touhoulittlemaid.geckolib3.core.processor.AnimationProcessor<any>;
        toString(): string;
        notifyAll(): void;
        hashCode(): number;
        setChair(arg0: Internal.ChairModelInfo_): void;
        updateModel(): boolean;
        wait(): void;
        wait(arg0: number): void;
        equals(arg0: any): boolean;
        addAnimationController(arg0: Internal.AnimationController_<any>): void;
        getCurrentModel(): Internal.AnimatedGeoModel;
        get class(): typeof any
        get entity(): Internal.EntityChair
        get modelLocation(): ResourceLocation
        get animationData(): Internal.AnimationData
        get seekTime(): number
        get animationFileLocation(): ResourceLocation
        get textureLocation(): ResourceLocation
        set molangQueries(arg0: number)
        get chairInfo(): Internal.ChairModelInfo
        get animationProcessor(): com.github.tartaricacid.touhoulittlemaid.geckolib3.core.processor.AnimationProcessor<any>
        set chair(arg0: Internal.ChairModelInfo_)
        get currentModel(): Internal.AnimatedGeoModel
    }
    type GeckoChairEntity_ = GeckoChairEntity;
    ...
    class ColorFieldBuilder extends Internal.AbstractFieldBuilder<number, Internal.ColorEntry, Internal.ColorFieldBuilder> {
        ...
        setAlphaMode(withAlpha: boolean): this;
        ...
        setSaveConsumer2(saveConsumer: Internal.Consumer_<me.shedaniel.math.Color>): this;
        getSaveConsumer(): Internal.Consumer<number>;
        requireRestart(requireRestart: boolean): void;
        toString(): string;
        build(): Internal.ColorEntry;
        notifyAll(): void;
        setSaveConsumer3(saveConsumer: Internal.Consumer_<Internal.TextColor>): this;
        "setTooltipSupplier(java.util.function.Function)"(arg0: Internal.Function_<any, any>): Internal.FieldBuilder<any, any, any>;
        setDefaultValue3(defaultValue: Internal.Supplier_<Internal.TextColor>): this;
        getDefaultValue(): Internal.Supplier<number>;
        setDefaultValue(defaultValue: Internal.Supplier_<number>): this;
        setDefaultValue(defaultValue: number): this;
        setDefaultValue(defaultValue: Internal.TextColor_): this;
        setDefaultValue2(defaultValue: Internal.Supplier_<me.shedaniel.math.Color>): this;
        /**
         * @deprecated
        */
        ...
        "setDefaultValue(net.minecraft.network.chat.TextColor)"(defaultValue: Internal.TextColor_): this;
        equals(arg0: any): boolean;
        ...
        set requirement(requirement: Internal.Requirement_)
        set alphaMode(withAlpha: boolean)
        ...
        set saveConsumer2(saveConsumer: Internal.Consumer_<me.shedaniel.math.Color>)
        get saveConsumer(): Internal.Consumer<number>
        set saveConsumer3(saveConsumer: Internal.Consumer_<Internal.TextColor>)
        set "tooltipSupplier(java.util.function.Function)"(arg0: Internal.Function_<any, any>)
        set defaultValue3(defaultValue: Internal.Supplier_<Internal.TextColor>)
        get defaultValue(): Internal.Supplier<number>
        set defaultValue(defaultValue: Internal.Supplier_<number>)
        set defaultValue(defaultValue: number)
        set defaultValue(defaultValue: Internal.TextColor_)
        set defaultValue2(defaultValue: Internal.Supplier_<me.shedaniel.math.Color>)
        ...
        set "defaultValue(net.minecraft.network.chat.TextColor)"(defaultValue: Internal.TextColor_)
        set "tooltip(net.minecraft.network.chat.Component[])"(arg0: net.minecraft.network.chat.Component_[])
    }
    type ColorFieldBuilder_ = ColorFieldBuilder;
    ...
    class ModelPart implements Internal.ModelPartData, Internal.ModelPartAccessor, Internal.ModelPartExtended {
    ...
    class BoneTopLevelSnapshot extends Internal.BoneSnapshot {
        constructor(arg0: Internal.IBone_)
        constructor(arg0: Internal.IBone_, arg1: boolean)
        getClass(): typeof any;
        hashCode(): number;
        ...
        wait(arg0: number, arg1: number): void;
        get class(): typeof any
        readonly bone: Internal.IBone;
        isCurrentlyRunningRotationAnimation: boolean;
        mostRecentResetScaleTick: number;
        isCurrentlyRunningScaleAnimation: boolean;
        mostRecentResetRotationTick: number;
        isCurrentlyRunningPositionAnimation: boolean;
        readonly cachedPointData: Internal.PointData;
        mostRecentResetPositionTick: number;
    }
    type BoneTopLevelSnapshot_ = BoneTopLevelSnapshot;
    ...
    interface ExpressionEvaluator <TEntity> extends Internal.ExpressionVisitor<any>, Internal.ExecutionContext<TEntity> {
        visitAssignableVariable(arg0: Internal.AssignableVariableExpression_): any;
        evaluator(): Internal.ExpressionEvaluator<any>;
        visitString(arg0: Internal.StringExpression_): any;
        abstract createChild<TNewEntity>(arg0: TNewEntity): Internal.ExpressionEvaluator<TNewEntity>;
        visitExecutionScope(arg0: Internal.ExecutionScopeExpression_): any;
        abstract popReturnValue(): any;
        evaluator<TEntity>(arg0: TEntity): this;
        visitVariable(arg0: Internal.VariableExpression_): any;
        visitUnary(arg0: Internal.UnaryExpression_): any;
        "eval"(arg0: Internal.Expression_): any;
        visitStatement(arg0: Internal.StatementExpression_): any;
        visitDouble(arg0: Internal.DoubleExpression_): any;
        visitStruct(arg0: Internal.StructAccessExpression_): any;
        abstract entity(): TEntity;
        abstract visit(arg0: Internal.Expression_): any;
        buildExecutionScopeFunction(arg0: Internal.ExecutionScopeExpression_): com.github.tartaricacid.touhoulittlemaid.molang.runtime.Function;
        visitIdentifier(arg0: Internal.IdentifierExpression_): any;
        abstract createChild(): this;
        visitCall(arg0: Internal.CallExpression_): any;
        visitTernaryConditional(arg0: Internal.TernaryConditionalExpression_): any;
        visitBinary(arg0: com.github.tartaricacid.touhoulittlemaid.molang.parser.ast.BinaryExpression_): any;
    }
    type ExpressionEvaluator_<TEntity> = ExpressionEvaluator<TEntity>;
    ...
    class PlayerRenderer extends Internal.LivingEntityRenderer<Internal.AbstractClientPlayer, Internal.PlayerModel<Internal.AbstractClientPlayer>> {
        ...
        tlm$renderNameTag(arg0: Internal.LivingEntity_, arg1: number, arg2: number, arg3: Internal.PoseStack_, arg4: Internal.MultiBufferSource_, arg5: number): void;
        ...
        handler$bcd000$enderio$rotatePlayerInGlider(arg0: Internal.LivingEntity_, arg1: Internal.PoseStack_, arg2: number, arg3: number, arg4: number, arg5: Internal.CallbackInfo_): void;
...
declare namespace me.shedaniel.math {
    class Dimension implements Internal.Cloneable {
        constructor()
        constructor(arg0: me.shedaniel.math.Dimension_)
        constructor(arg0: number, arg1: number)
        constructor(arg0: Internal.FloatingDimension_)
        constructor(arg0: number, arg1: number)
        clone(): any;
        getClass(): typeof any;
        getFloatingSize(): Internal.FloatingDimension;
        toString(): string;
        setSize(arg0: number, arg1: number): void;
        "setSize(me.shedaniel.math.FloatingDimension)"(arg0: Internal.FloatingDimension_): void;
        getWidth(): number;
        setSize(arg0: Internal.FloatingDimension_): void;
        notifyAll(): void;
        "setSize(double,double)"(arg0: number, arg1: number): void;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        "setSize(me.shedaniel.math.Dimension)"(arg0: me.shedaniel.math.Dimension_): void;
        hashCode(): number;
        wait(): void;
        "setSize(int,int)"(arg0: number, arg1: number): void;
        setSize(arg0: number, arg1: number): void;
        wait(arg0: number): void;
        setSize(arg0: me.shedaniel.math.Dimension_): void;
        equals(arg0: any): boolean;
        getHeight(): number;
        getSize(): this;
        get class(): typeof any
        get floatingSize(): Internal.FloatingDimension
        set "size(me.shedaniel.math.FloatingDimension)"(arg0: Internal.FloatingDimension_)
        get width(): number
        set size(arg0: Internal.FloatingDimension_)
        set "size(me.shedaniel.math.Dimension)"(arg0: me.shedaniel.math.Dimension_)
        set size(arg0: me.shedaniel.math.Dimension_)
        get height(): number
        get size(): me.shedaniel.math.Dimension
        width: number;
        height: number;
    }
