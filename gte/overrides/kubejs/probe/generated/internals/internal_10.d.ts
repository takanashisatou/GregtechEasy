...
declare namespace org.antlr.v4.runtime {
    interface IntStream {
        abstract LA(arg0: number): number;
        abstract getSourceName(): string;
        abstract size(): number;
        abstract consume(): void;
        abstract mark(): number;
        abstract index(): number;
        abstract seek(arg0: number): void;
        abstract release(arg0: number): void;
        get sourceName(): string
        readonly EOF: (-1) & (number);
        readonly UNKNOWN_SOURCE_NAME: ("<unknown>") & (string);
    }
...
declare namespace Internal {
    ...
    class UnaryExpression$Op extends Internal.Enum<Internal.UnaryExpression$Op> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        toString(): string;
        "compareTo(com.github.tartaricacid.touhoulittlemaid.molang.parser.ast.UnaryExpression$Op)"(arg0: Internal.UnaryExpression$Op_): number;
        notifyAll(): void;
        precedence(): number;
        static valueOf(arg0: string): Internal.UnaryExpression$Op;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        name(): string;
        hashCode(): number;
        getDeclaringClass(): typeof Internal.UnaryExpression$Op;
        static values(): Internal.UnaryExpression$Op[];
        ordinal(): number;
        wait(): void;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.UnaryExpression$Op>>;
        wait(arg0: number): void;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        compareTo(arg0: Internal.UnaryExpression$Op_): number;
        get class(): typeof any
        get declaringClass(): typeof Internal.UnaryExpression$Op
        static readonly ARITHMETICAL_NEGATION: (Internal.UnaryExpression$Op) & (Internal.UnaryExpression$Op);
        static readonly PLUS: (Internal.UnaryExpression$Op) & (Internal.UnaryExpression$Op);
        static readonly RETURN: (Internal.UnaryExpression$Op) & (Internal.UnaryExpression$Op);
        static readonly LOGICAL_NEGATION: (Internal.UnaryExpression$Op) & (Internal.UnaryExpression$Op);
    }
    type UnaryExpression$Op_ = "return" | "plus" | UnaryExpression$Op | "arithmetical_negation" | "logical_negation";
    ...
    interface FloatList extends Internal.Comparable<Internal.List<number>>, Internal.List<number>, Internal.FloatCollection {
        ...
        */
        ...
        abstract listIterator(arg0: number): Internal.FloatListIterator;
    ...
    abstract class AbstractRangeListBuilder <T, A extends Internal.AbstractConfigListEntry<any>, SELF extends Internal.AbstractRangeListBuilder<T, A, SELF>> extends Internal.AbstractListBuilder<T, A, SELF> {
        setErrorSupplier(errorSupplier: Internal.Function_<Internal.List<T>, Internal.Optional<net.minecraft.network.chat.Component>>): SELF;
        requireRestart(): SELF;
        removeMax(): SELF;
        abstract build(): A;
        isInsertInFront(): boolean;
        setDefaultValue(defaultValue: Internal.Supplier_<Internal.List<T>>): SELF;
        getRemoveTooltip(): net.minecraft.network.chat.Component;
        setDefaultValue(defaultValue: Internal.List_<T>): SELF;
        ...
        "setTooltipSupplier(java.util.function.Function)"(tooltipSupplier: Internal.Function_<Internal.List<T>, Internal.Optional<net.minecraft.network.chat.Component[]>>): SELF;
        ...
        setSaveConsumer(saveConsumer: Internal.Consumer_<Internal.List<T>>): SELF;
        setTooltipSupplier(tooltipSupplier: Internal.Function_<Internal.List<T>, Internal.Optional<net.minecraft.network.chat.Component[]>>): SELF;
        getTooltipSupplier(): Internal.Function<Internal.List<T>, Internal.Optional<net.minecraft.network.chat.Component[]>>;
        setCellErrorSupplier(cellErrorSupplier: Internal.Function_<T, Internal.Optional<net.minecraft.network.chat.Component>>): SELF;
        ...
        */
        ...
        setAddButtonTooltip(addTooltip: net.minecraft.network.chat.Component_): SELF;
        "setDefaultValue(java.util.List)"(defaultValue: Internal.List_<T>): SELF;
        wait(): void;
        getClass(): typeof any;
        ...
        setMin(min: T): SELF;
        wait(arg0: number, arg1: number): void;
        setRemoveButtonTooltip(removeTooltip: net.minecraft.network.chat.Component_): SELF;
        setMax(max: T): SELF;
        ...
        getCellErrorSupplier(): Internal.Function<T, Internal.Optional<net.minecraft.network.chat.Component>>;
        isExpanded(): boolean;
        hashCode(): number;
        ...
        "setDefaultValue(java.util.function.Supplier)"(defaultValue: Internal.Supplier_<Internal.List<T>>): SELF;
        set errorSupplier(errorSupplier: Internal.Function_<Internal.List<T>, Internal.Optional<net.minecraft.network.chat.Component>>)
        get insertInFront(): boolean
        set defaultValue(defaultValue: Internal.Supplier_<Internal.List<T>>)
        get removeTooltip(): net.minecraft.network.chat.Component
        set defaultValue(defaultValue: Internal.List_<T>)
        ...
        set "tooltipSupplier(java.util.function.Function)"(tooltipSupplier: Internal.Function_<Internal.List<T>, Internal.Optional<net.minecraft.network.chat.Component[]>>)
        ...
        set saveConsumer(saveConsumer: Internal.Consumer_<Internal.List<T>>)
        set tooltipSupplier(tooltipSupplier: Internal.Function_<Internal.List<T>, Internal.Optional<net.minecraft.network.chat.Component[]>>)
        get tooltipSupplier(): Internal.Function<Internal.List<T>, Internal.Optional<net.minecraft.network.chat.Component[]>>
        set cellErrorSupplier(cellErrorSupplier: Internal.Function_<T, Internal.Optional<net.minecraft.network.chat.Component>>)
        ...
        set addButtonTooltip(addTooltip: net.minecraft.network.chat.Component_)
        set "defaultValue(java.util.List)"(defaultValue: Internal.List_<T>)
        get class(): typeof any
        ...
        get cellErrorSupplier(): Internal.Function<T, Internal.Optional<net.minecraft.network.chat.Component>>
        ...
        set "defaultValue(java.util.function.Supplier)"(defaultValue: Internal.Supplier_<Internal.List<T>>)
    }
    type AbstractRangeListBuilder_<T, A extends Internal.AbstractConfigListEntry<any>, SELF extends Internal.AbstractRangeListBuilder<T, A, SELF>> = AbstractRangeListBuilder<T, A, SELF>;
    ...
    class DirectionQualifier extends Internal.Record implements Internal.ASTNode, Internal.Iterable<Internal.Direction> {
        constructor(directions: Internal.EnumSet_<Internal.Direction>)
        static lookup(arg0: Internal.Side_): Internal.Direction;
        getClass(): typeof any;
        stream(): Internal.Stream<Internal.Direction>;
        toString(): string;
        spliterator(): Internal.Spliterator<Internal.Direction>;
        notifyAll(): void;
        directions(): Internal.EnumSet<Internal.Direction>;
        getStatements(): Internal.List<ca.teamdman.sfml.ast.Statement>;
        iterator(): Internal.Iterator<Internal.Direction>;
        static directionToString(arg0: Internal.Direction_): string;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        ...
        static readonly EVERY_DIRECTION: (Internal.DirectionQualifier) & (Internal.DirectionQualifier);
        static readonly NULL_DIRECTION: (Internal.DirectionQualifier) & (Internal.DirectionQualifier);
    }
    type DirectionQualifier_ = DirectionQualifier;
    ...
    class ExtraStackedWasteBarrel extends Internal.VariableCapacityChemicalTank<Internal.Gas, Internal.GasStack> implements Internal.IGasTank, Internal.IGasHandler {
        abstract getTankCapacity(arg0: number): number;
        "isTypeEqual(mekanism.api.chemical.gas.Gas)"(arg0: Internal.Gas_): boolean;
        insert(arg0: Internal.ChemicalStack_<any>, arg1: Internal.Action_, arg2: Internal.AutomationType_): Internal.ChemicalStack<any>;
        ...
        static create(arg0: Internal.ExtraTileEntityRadioactiveWasteBarrel_, arg1: Internal.IContentsListener_): Internal.ExtraStackedWasteBarrel;
        abstract insertChemical(arg0: number, arg1: Internal.GasStack_, arg2: Internal.Action_): Internal.GasStack;
        getNeeded(): number;
        "insert(mekanism.api.chemical.ChemicalStack,mekanism.api.Action,mekanism.api.AutomationType)"(arg0: Internal.ChemicalStack_<any>, arg1: Internal.Action_, arg2: Internal.AutomationType_): Internal.ChemicalStack<any>;
        ...
        toString(): string;
        notifyAll(): void;
        "insert(mekanism.api.chemical.gas.GasStack,mekanism.api.Action,mekanism.api.AutomationType)"(arg0: Internal.GasStack_, arg1: Internal.Action_, arg2: Internal.AutomationType_): Internal.GasStack;
        ...
        insert(arg0: Internal.GasStack_, arg1: Internal.Action_, arg2: Internal.AutomationType_): Internal.GasStack;
    ...
    type ExtraStackedWasteBarrel_ = ExtraStackedWasteBarrel;
    ...
    interface IOptionalSlotHost {
        abstract isSlotEnabled(arg0: number): boolean;
        (arg0: number): boolean;
    }
    type IOptionalSlotHost_ = IOptionalSlotHost | ((arg0: number)=> boolean);
    ...
    class ReturnStatement extends Internal.Statement {
        ...
        notify(): void;
        static make(pos: number, expression: icyllis.arc3d.compiler.tree.Expression_): Internal.Statement;
        wait(arg0: number, arg1: number): void;
        getStartOffset(): number;
        hashCode(): number;
        getExpression(): icyllis.arc3d.compiler.tree.Expression;
        wait(): void;
        setExpression(expression: icyllis.arc3d.compiler.tree.Expression_): void;
        wait(arg0: number): void;
        equals(arg0: any): boolean;
        get class(): typeof any
        ...
        get expression(): icyllis.arc3d.compiler.tree.Expression
        set expression(expression: icyllis.arc3d.compiler.tree.Expression_)
    }
    ...
    class ItemPortableFECell extends Internal.AbstractPortableCell implements Internal.IFluxCell {
        constructor(arg0: number, arg1: number, arg2: number)
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        isEnderMask(arg0: Internal.ItemStack_, arg1: Internal.Player_, arg2: Internal.EnderMan_): boolean;
    ...
    type ItemPortableFECell_ = ItemPortableFECell;
    ...
    class SFMLParser$SetOpContext extends Internal.ParserRuleContext {
        constructor(arg0: Internal.ParserRuleContext_, arg1: number)
        LONE(): Internal.TerminalNode;
    ...
    type SFMLParser$SetOpContext_ = SFMLParser$SetOpContext;
    ...
    class InfinityCellItem extends Internal.Item {
        constructor(arg0: Internal.AEKeyType_)
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
        isEnderMask(arg0: Internal.ItemStack_, arg1: Internal.Player_, arg2: Internal.EnderMan_): boolean;
    ...
    type InfinityCellItem_ = InfinityCellItem;
    ...
    interface TTSClient extends Internal.Client {
        isSuccessful(arg0: Internal.HttpResponse_<any>): boolean;
        abstract play(arg0: string, arg1: Internal.TTSConfig_, arg2: Internal.ResponseCallback_<number[]>): void;
        handleResponse(arg0: Internal.ResponseCallback_<number[]>, arg1: Internal.HttpResponse_<number[]>, arg2: Internal.Throwable_, arg3: Internal.HttpRequest_): void;
        (arg0: string, arg1: Internal.TTSConfig, arg2: Internal.ResponseCallback<number[]>): void;
    }
    type TTSClient_ = ((arg0: string, arg1: Internal.TTSConfig, arg2: Internal.ResponseCallback<number[]>)=> void) | TTSClient;
    ...
    class PrintingPressBlockEntity extends Internal.BlockEntity implements Internal.NotContainer {
        ...
        */
        ...
        saveWithoutMetadata(): Internal.CompoundTag;
        setTimeout(): void;
        acceptStack(arg0: Internal.ItemStack_): Internal.ItemStack;
        "setChanged()"(): void;
        ...
        getModelData(): Internal.ModelData;
        isMutable(): boolean;
        getStacksToDrop(): Internal.ItemStack[];
        ...
        */
        ...
        get class(): typeof any
        get updatePacket(): Internal.Packet<Internal.ClientGamePacketListener>
        get ink(): Internal.ItemStack
        get height(): number
        get persistentData(): Internal.CompoundTag
        get form(): Internal.ItemStack
        get updateTag(): Internal.CompoundTag
        set level(arg0: Internal.Level_)
        get blockPos(): BlockPos
        get slots(): number
        ...
        get empty(): boolean
        get level(): Internal.Level
        get paper(): Internal.ItemStack
        get allItems(): Internal.List<Internal.ItemStack>
        get forcedVisible(): boolean
        get modelData(): Internal.ModelData
        get mutable(): boolean
        get stacksToDrop(): Internal.ItemStack[]
    }
    type PrintingPressBlockEntity_ = PrintingPressBlockEntity;
    ...
    class DoubleListListEntry extends Internal.AbstractTextFieldListListEntry<number, Internal.DoubleListListEntry$DoubleListCell, Internal.DoubleListListEntry> {
        ...
        */
        ...
        setCreateNewInstance(createNewInstance: Internal.Function_<Internal.DoubleListListEntry, Internal.DoubleListListEntry$DoubleListCell>): void;
        notifyAll(): void;
        save(): void;
        isExpanded(): boolean;
        ...
        getCreateNewInstance(): Internal.Function<Internal.DoubleListListEntry, Internal.DoubleListListEntry$DoubleListCell>;
        ...
        */
        ...
        set displayRequirement(requirement: Internal.Requirement_)
        get createNewInstance(): Internal.Function<Internal.DoubleListListEntry, Internal.DoubleListListEntry$DoubleListCell>
    ...
    type DoubleListListEntry_ = DoubleListListEntry;
    class TypeWrappers {
        constructor()
        getClass(): typeof any;
    ...
    class BlendMode extends Internal.Enum<Internal.BlendMode> implements icyllis.arc3d.core.Blender {
        static blend_vivid_light(src: number[], dst: number[], out: number[]): void;
        static blend_src_atop(src: number[], dst: number[], out: number[]): void;
        static blend_pin_light(src: number[], dst: number[], out: number[]): void;
        isAdvanced(): boolean;
        static blend_src_over(src: number[], dst: number[], out: number[]): void;
        notify(): void;
        compareTo(arg0: any): number;
        unref(): void;
        static valueOf(name: string): Internal.BlendMode;
        static blend_darken(src: number[], dst: number[], out: number[]): void;
        static blend_dst_atop(src: number[], dst: number[], out: number[]): void;
        static blend_linear_dodge(src: number[], dst: number[], out: number[]): void;
        static blend_dst_out(src: number[], dst: number[], out: number[]): void;
        static blend_divide(src: number[], dst: number[], out: number[]): void;
        static blend_overlay(src: number[], dst: number[], out: number[]): void;
        static blend_soft_light(src: number[], dst: number[], out: number[]): void;
        "compareTo(icyllis.arc3d.core.BlendMode)"(arg0: Internal.BlendMode_): number;
        compareTo(arg0: Internal.BlendMode_): number;
        static blend_exclusion(src: number[], dst: number[], out: number[]): void;
        ref(): void;
        static blend_hue(src: number[], dst: number[], out: number[]): void;
        static blend_xor(src: number[], dst: number[], out: number[]): void;
        name(): string;
        static blend_src_out(src: number[], dst: number[], out: number[]): void;
        static blend_plus(src: number[], dst: number[], out: number[]): void;
        static blend_linear_burn(src: number[], dst: number[], out: number[]): void;
        static blend_luminosity(src: number[], dst: number[], out: number[]): void;
        static blend_linear_light(src: number[], dst: number[], out: number[]): void;
        wait(): void;
        asBlendMode(): this;
        "compareTo(java.lang.Object)"(arg0: any): number;
        static blend_color_dodge(src: number[], dst: number[], out: number[]): void;
        getClass(): typeof any;
        static blend_color(src: number[], dst: number[], out: number[]): void;
        static blend_dst_in(src: number[], dst: number[], out: number[]): void;
        static blend_src_in(src: number[], dst: number[], out: number[]): void;
        static blend_multiply(src: number[], dst: number[], out: number[]): void;
        static blend_subtract(src: number[], dst: number[], out: number[]): void;
        static blend_color_burn(src: number[], dst: number[], out: number[]): void;
        getDeclaringClass(): typeof Internal.BlendMode;
        static blend_saturation(src: number[], dst: number[], out: number[]): void;
        wait(arg0: number, arg1: number): void;
        static values(): Internal.BlendMode[];
        static blend_difference(src: number[], dst: number[], out: number[]): void;
        static blend_hard_light(src: number[], dst: number[], out: number[]): void;
        static blend_hard_mix(src: number[], dst: number[], out: number[]): void;
        static blend_modulate(src: number[], dst: number[], out: number[]): void;
        static blend_minus_clamped(src: number[], dst: number[], out: number[]): void;
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        toString(): string;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.BlendMode>>;
        notifyAll(): void;
        static blend_plus_clamped(src: number[], dst: number[], out: number[]): void;
        static blend_darker_color(src: number[], dst: number[], out: number[]): void;
        static blend_dst_over(src: number[], dst: number[], out: number[]): void;
        static blend_screen(src: number[], dst: number[], out: number[]): void;
        static blend_minus(src: number[], dst: number[], out: number[]): void;
        hashCode(): number;
        static blend_lighten(src: number[], dst: number[], out: number[]): void;
        apply(src: number[], dst: number[], out: number[]): void;
        static blend_lighter_color(src: number[], dst: number[], out: number[]): void;
        ordinal(): number;
        wait(arg0: number): void;
        getBlendFuncName(): string;
        equals(arg0: any): boolean;
        static modeAt(index: number): Internal.BlendMode;
        get advanced(): boolean
        get class(): typeof any
        get declaringClass(): typeof Internal.BlendMode
        get blendFuncName(): string
        static readonly COLOR_DODGE: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly SRC: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly LINEAR_LIGHT: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly CLEAR: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly OVERLAY: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly DST_IN: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly COLOR: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly COLOR_BURN: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly SRC_IN: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly SOFT_LIGHT: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly LINEAR_BURN: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly PLUS: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly HARD_LIGHT: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly HARD_MIX: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly LUMINOSITY: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly DST_OUT: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly SRC_ATOP: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly COUNT: (42) & (number);
        static readonly DST: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly SATURATION: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly SRC_OUT: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly DST_ATOP: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly SRC_OVER: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly MODULATE: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly EXCLUSION: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly DARKER_COLOR: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly DST_OVER: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly XOR: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly PIN_LIGHT: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly MULTIPLY: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly LIGHTER_COLOR: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly SCREEN: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly PLUS_CLAMPED: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly SUBTRACT: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly VIVID_LIGHT: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly DARKEN: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly HUE: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly DIFFERENCE: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly LIGHTEN: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly MINUS_CLAMPED: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly ADD: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly MINUS: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly DIVIDE: (Internal.BlendMode) & (Internal.BlendMode);
        static readonly LINEAR_DODGE: (Internal.BlendMode) & (Internal.BlendMode);
    }
    ...
    class ColorEntry extends Internal.TextFieldListEntry<number> {
        constructor(fieldName: net.minecraft.network.chat.Component_, value: number, resetButtonKey: net.minecraft.network.chat.Component_, defaultValue: Internal.Supplier_<number>, saveConsumer: Internal.Consumer_<number>, tooltipSupplier: Internal.Supplier_<Internal.Optional<net.minecraft.network.chat.Component[]>>, requiresRestart: boolean)
        setReferenceProviderEntries(referencableEntries: Internal.List_<Internal.ReferenceProvider<any>>): void;
        charTyped(c: string, i: number): boolean;
        "setFocused(net.minecraft.client.gui.components.events.GuiEventListener)"(guiEventListener: Internal.GuiEventListener_): void;
        setTooltipSupplier(tooltipSupplier: Internal.Supplier_<Internal.Optional<net.minecraft.network.chat.Component[]>>): void;
        getDefaultValue(): Internal.Optional<number>;
        setFocused(arg0: boolean): void;
        setErrorSupplier(errorSupplier: Internal.Supplier_<Internal.Optional<net.minecraft.network.chat.Component>>): void;
        mouseClicked(d: number, e: number, i: number): boolean;
        keyReleased(i: number, j: number, k: number): boolean;
        ...
        getConfigError(): Internal.Optional<net.minecraft.network.chat.Component>;
        render(graphics: Internal.GuiGraphics_, index: number, y: number, x: number, entryWidth: number, entryHeight: number, mouseX: number, mouseY: number, isHovered: boolean, delta: number): void;
        provideReferenceEntry(): Internal.AbstractConfigEntry<number>;
        setDisplayRequirement(requirement: Internal.Requirement_): void;
        getRequirement(): Internal.Requirement;
        isMouseInside(mouseX: number, mouseY: number, x: number, y: number, entryWidth: number, entryHeight: number): boolean;
        mouseMoved(arg0: number, arg1: number): void;
         ...
         * @deprecated
        */
        "setValue(java.lang.String)"(s: string): void;
        getValue(): any;
        keyPressed(i: number, j: number, k: number): boolean;
        tick(): void;
        getTooltip(mouseX: number, mouseY: number): Internal.Optional<net.minecraft.network.chat.Component[]>;
        ...
        */
         ...
         * @deprecated
        */
        "setValue(int)"(color: number): void;
        isActive(): boolean;
        getTabOrderGroup(): number;
        setFocused(guiEventListener: Internal.GuiEventListener_): void;
        mouseScrolled(d: number, e: number, f: number): boolean;
        ...
        set "focused(net.minecraft.client.gui.components.events.GuiEventListener)"(guiEventListener: Internal.GuiEventListener_)
        set tooltipSupplier(tooltipSupplier: Internal.Supplier_<Internal.Optional<net.minecraft.network.chat.Component[]>>)
        get defaultValue(): Internal.Optional<number>
        set focused(arg0: boolean)
        set errorSupplier(errorSupplier: Internal.Supplier_<Internal.Optional<net.minecraft.network.chat.Component>>)
        set requiresRestart(requiresRestart: boolean)
        get configError(): Internal.Optional<net.minecraft.network.chat.Component>
         ...
         * @deprecated
        */
        set "value(java.lang.String)"(s: string)
        get value(): any
        get referenceProviderEntries(): Internal.List<Internal.ReferenceProvider<any>>
        /**
         * @deprecated
    ...
    type GenerationID_ = GenerationID;
    ...
    class DoubleListListEntry$DoubleListCell extends Internal.AbstractTextFieldListListEntry$AbstractTextFieldListCell<number, Internal.DoubleListListEntry$DoubleListCell, Internal.DoubleListListEntry> {
        constructor(value: number, listListEntry: Internal.DoubleListListEntry_)
        ...
        isRequiresRestart(): boolean;
        getConfigError(): Internal.Optional<net.minecraft.network.chat.Component>;
        render(graphics: Internal.GuiGraphics_, index: number, y: number, x: number, entryWidth: number, entryHeight: number, mouseX: number, mouseY: number, isSelected: boolean, delta: number): void;
    ...
    type DoubleListListEntry$DoubleListCell_ = DoubleListListEntry$DoubleListCell;
    ...
    interface HttpRequest$Builder {
        abstract uri(arg0: Internal.URI_): this;
        abstract DELETE(): this;
        abstract setHeader(arg0: string, arg1: string): this;
        abstract expectContinue(arg0: boolean): this;
        abstract GET(): this;
        abstract header(arg0: string, arg1: string): this;
        abstract timeout(arg0: Duration_): this;
        abstract method(arg0: string, arg1: Internal.HttpRequest$BodyPublisher_): this;
        HEAD(): this;
        abstract headers(...arg0: string[]): this;
        abstract PUT(arg0: Internal.HttpRequest$BodyPublisher_): this;
        abstract version(arg0: Internal.HttpClient$Version_): this;
        abstract POST(arg0: Internal.HttpRequest$BodyPublisher_): this;
        abstract copy(): this;
        abstract build(): Internal.HttpRequest;
    }
    type HttpRequest$Builder_ = HttpRequest$Builder;
    ...
    class BinaryExpression extends icyllis.arc3d.compiler.tree.Expression {
        getClass(): typeof any;
        getCoercionCost(other: icyllis.arc3d.compiler.tree.Type_): number;
        getEndOffset(): number;
        getRight(): icyllis.arc3d.compiler.tree.Expression;
        getConstantValue(i: number): Internal.OptionalDouble;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        getStartOffset(): number;
        clone(): icyllis.arc3d.compiler.tree.Expression;
        static make(context: icyllis.arc3d.compiler.Context_, pos: number, left: icyllis.arc3d.compiler.tree.Expression_, op: Internal.Operator_, right: icyllis.arc3d.compiler.tree.Expression_, resultType: icyllis.arc3d.compiler.tree.Type_): icyllis.arc3d.compiler.tree.Expression;
        isIncomplete(context: icyllis.arc3d.compiler.Context_): boolean;
        isLiteral(): boolean;
        clone(position: number): icyllis.arc3d.compiler.tree.Expression;
        setLeft(left: icyllis.arc3d.compiler.tree.Expression_): void;
        getOperator(): Internal.Operator;
        setRight(right: icyllis.arc3d.compiler.tree.Expression_): void;
        toString(): string;
        ...
        hashCode(): number;
        getLeft(): icyllis.arc3d.compiler.tree.Expression;
        wait(): void;
        toString(parentPrecedence: number): string;
        static convert(context: icyllis.arc3d.compiler.Context_, position: number, left: icyllis.arc3d.compiler.tree.Expression_, op: Internal.Operator_, right: icyllis.arc3d.compiler.tree.Expression_): icyllis.arc3d.compiler.tree.Expression;
        wait(arg0: number): void;
        equals(arg0: any): boolean;
        ...
        get class(): typeof any
        get endOffset(): number
        get right(): icyllis.arc3d.compiler.tree.Expression
        get startOffset(): number
        get literal(): boolean
        set left(left: icyllis.arc3d.compiler.tree.Expression_)
        get operator(): Internal.Operator
        set right(right: icyllis.arc3d.compiler.tree.Expression_)
        ...
        get left(): icyllis.arc3d.compiler.tree.Expression
...
declare namespace icyllis.arc3d.core.shaders {
    interface Shader extends Internal.RefCounted {
        abstract unref(): void;
        isOpaque(): boolean;
        isConstant(): boolean;
        asGradient(): number;
        abstract ref(): void;
        makeWithLocalMatrix(localMatrix: Internal.Matrixc_): this;
        get opaque(): boolean
        get constant(): boolean
        readonly TILE_MODE_DECAL: (3) & (number);
        readonly TILE_MODE_REPEAT: (0) & (number);
        readonly GRADIENT_TYPE_LINEAR: (1) & (number);
        readonly GRADIENT_TYPE_ANGULAR: (3) & (number);
        readonly TILE_MODE_CLAMP: (2) & (number);
        readonly GRADIENT_TYPE_NONE: (0) & (number);
        readonly TILE_MODE_MIRROR: (1) & (number);
        readonly GRADIENT_TYPE_RADIAL: (2) & (number);
        readonly LAST_TILE_MODE: (3) & (number);
    }
    type Shader_ = Shader;
}
